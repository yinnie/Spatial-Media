...
void testApp::setup(){
	...
	//img3 = new smImage  ("/Users/yinliu/Downloads/SM12_flood_fill_images_v2/flood_fill_test_03.raw",320,240);
...
bool testApp::seedFill(int x, int y, int label) {
	...
	if(x>1 && y>1 && x<img1->width-1 && y<img1->height-1){ //constrain for pixels to be within range
